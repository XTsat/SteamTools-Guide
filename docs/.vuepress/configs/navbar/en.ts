    ...
    children: [
      {
        ...
        children: [
          {
            text: 'Gitee releases(Instant update)',
            link: 'https://gitee.com/rmbgame/SteamTools/releases'
          },
          {
            text: 'GitHub releases(Instant update)',
          ...
          {
            text: 'cowtransfer(The transfer error)',
            link: 'https://cowtransfer.com/s/94ce5dfa928f45'
          },
        ]
      },
      {
        text: 'Note:Some channels cannot be updated instantly',
